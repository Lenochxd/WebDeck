...
move "%current_dir%\dist\WD_main\*" "%current_dir%\dist\WebDeck\"
...
move "%current_dir%\dist\WD_start\*" "%current_dir%\dist\WebDeck\"

REM copier racine dans /dist/WebDeck
move "%current_dir%\dist\WebDeck\Webdeck\*" "%current_dir%\dist\Webdeck\"
